  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--ivory)', display: 'flex', alignItems: 'center', justifyContent: 'center', paddingTop: 72 }}>
      ...
      >
        ...
        <div style={{ fontSize: 11, fontWeight: 600, letterSpacing: '2px', textTransform: 'uppercase', color: 'var(--gold)', marginBottom: 10, fontFamily: "'DM Mono', monospace" }}>— Apply for Membership</div>
        <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 32, fontWeight: 700, color: 'var(--navy)', letterSpacing: '-1px', marginBottom: 8 }}>Create Account</h1>
        <p style={{ fontSize: 15, color: 'var(--navy-light)', marginBottom: 32, lineHeight: 1.6 }}>Join Vowza&apos;s private network of verified buyers and investors.</p>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'grid', gap: 20 }}>
          ...
          <button type="submit" disabled={loading} style={{ background: 'var(--gold)', color: 'white', padding: '15px', borderRadius: 8, fontSize: 14, fontWeight: 600, border: 'none', cursor: loading ? 'not-allowed' : 'pointer', opacity: loading ? 0.7 : 1, transition: 'all 0.3s' }}>

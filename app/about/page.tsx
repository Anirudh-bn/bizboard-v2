  ...
  return (
    <>
      <div style={{ paddingTop: 106, background: 'var(--ivory)', minHeight: '100vh' }}>
        ...
        <div style={{ borderTop: '1px solid var(--border)', margin: '0 60px' }} />

        {/* Mission */}
        <section style={{ padding: '80px 60px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, maxWidth: 1100, margin: '0 auto', alignItems: 'center' }}>
        ...
        {/* Values */}
        <section style={{ padding: '80px 60px', background: 'var(--navy)', position: 'relative', overflow: 'hidden' }}>
